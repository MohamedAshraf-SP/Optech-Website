...
// import images
import images from "./Bookkeepingimg";
// import components
...
function Bookkeeper() {
  ...
  return (
    <>
      ...
      />
      <WhyHireAssistant
        title={"What a Virtual Recruiting Assistant Can Do For You"}
...
export default React.memo(Bookkeeper);
