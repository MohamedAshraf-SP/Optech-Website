...
// import images
import images from "./Loan_Processor_Virtual_img";
// import components
...
} from "./Loan_Processor_Virtual_arr";
import UseDocumnetTitle from "../../Hooks/UseDocumnetTitle";

function Loan_Processor_Virtual() {
  UseDocumnetTitle("Mortgage Processor");
  ...
  return (
    <>
      ...
      />
      <WhyHireAssistant
        title={" What a mortgage Assistant Can Do For You"}
...
export default React.memo(Loan_Processor_Virtual);
