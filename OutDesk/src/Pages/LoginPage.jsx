...
import loginimg from "/images/Fixed-Header/sass-hero.webp";
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      UserName: Yup.string()
        .matches(
          /^[A-Z][A-Za-z0-9]*$/,
          "Must start with a capital letter and be a mixed of letters and numbers"
        )
      ...
      Password: Yup.string()
        ...
        .required("Password is Required"), // This should trigger the "Required" message.
    }),
    onSubmit: (values) => {
    ...
    <>
      <section className="bg-white">
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
          <section
            className="relative flex h-32 items-end  lg:col-span-5 lg:h-full xl:col-span-6 bg-cover bg-center bg-no-repeat opacity-100"
            style={{ backgroundImage: `url(${loginimg})` }}
          >
            {/* <div className="w-full h-full overflow-hidden">
              <img alt="loginimg" src={loginimg} className="w-full h-full " />
            </div> */}

            <div className="hidden lg:relative lg:block lg:p-12">
              <h2 className="mt-6 text-2xl font-bold text-gray-100 sm:text-3xl md:text-4xl">
                Welcome to MyBudgetStaff 👋
              </h2>

              <p className="mt-4 leading-relaxed text-white font-medium capitalize">
                In the business world, time is your most valuable asset. Spend
                your time on what matters and leave the rest to a trained
                professional.
              </p>
            </div>
          </section>
          ...
          <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
            <div className="max-w-xl lg:max-w-3xl">
              ...
              >
                <div className="col-span-12 lg:w-[400px]">
                  <label
                    htmlFor="Email"
                ...
                <div className="col-span-12 lg:w-[400px] relative">
                  <label
                    htmlFor="Password"
                    className="block text-sm font-medium text-gray-700"
                  >
                  ...
                  <span className="absolute top-10 right-0 text-xl flex items-center justify-center px-4 text-black cursor-pointer duration-200  hover:text-gray-500">
                    {!passwordstatus ? (
                      <icons.BiSolidHide onClick={handlepassword} />
                    ) : (
                      <icons.BiShow onClick={handlepassword} />
                    )}
                  </span>
                ...
                <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                  <button
                    ...
                    className={`cursor-pointer outline-none w-full inline-block shrink-0 rounded-md border border-blue-600 px-12 py-3 text-sm font-medium transition 
                                ${
                                  !formik.isValid
